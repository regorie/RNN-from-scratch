...
if __name__=='__main__':
    ...
    with open(args.source_vocab, "rb") as sf,\
        ...
        src_w2i, src_i2w = src_vocab[0], src_vocab[1]
        trg_vocab = pickle.load(tf)
        trg_w2i, trg_i2w = trg_vocab[0], trg_vocab[1]
        del trg_vocab, src_vocab
    # setup model
    model = NTRNN(input_size=len(src_w2i), embedding_dim=args.embed_dim, hidden_size=args.hidden_dim, output_size=len(trg_w2i), 
